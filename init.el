...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ui nickel-mode package-lint proof-general gruvbox-theme doom-themes exec-path-from-shell multiple-cursors flycheck-ocaml merlin-eldoc rg auto-complete dune dune-format helm-gtags ocamlformat utop company lsp-mode rustic nlinum doom-modeline org markdown-mode magit gruber-darker-theme smex merlin tuareg))
...
(global-set-key (kbd "C-c SPC k") 'lsp-ui-doc-show)
